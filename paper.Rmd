...
We briefly recall the null plot generation procedure of @buja2009statistical. Draw an auxiliary response $\boldsymbol{w}$ with entries $w_i \overset{\text{iid}}{\sim} \mathcal{N}(0,1)$ and compute the projected residuals $\hat{\boldsymbol{e}}_w = \boldsymbol{R}\boldsymbol{w}$. These are then rescaled to match the Euclidean norm of the observed residuals, $\tilde{\boldsymbol{e}}_w = \hat{\boldsymbol{e}}_w \cdot \frac{\|\hat{\boldsymbol{e}}\|}{\|\hat{\boldsymbol{e}}_w\|},$
