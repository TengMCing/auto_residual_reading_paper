...
Details of the computer vision model architecture are provided in Section \ref{sec-model-architecture}, while the training procedure, including the generation of synthetic training data, is described in Section \ref{sec-model-data-generation}.

<!-- TODO if this citation is appropraite to demonstrate that synthetic data generation to train neural network is common \citep{fanSelectiveOverviewDeep2021}.  -->
