...
More importantly, the attention map in Figure \ref{fig:dino-check}B clearly exhibits a "dinosaur" shape, strongly suggesting the prediction of the distance is based on human perceptible visual patterns. The computer vision model is also capable of capturing the contour or the outline of the embedded shape, just like human being reading residual plots. The PCA in Figure \ref{fig:dino-check}D also shows that the cluster of bootstrapped plots is at the corner of the cluster of null plots. 
