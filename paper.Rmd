...
Model parameters $\boldsymbol{\theta}$ were randomly initialized using the Glorot Uniform method [@glorot2010understanding] and optimized with the Adam optimizer [@kingma2014adam] under a mean squared error objective:
