...
model_pred %>%
  ...
  kableExtra::kable(format = "latex",
                    ...
                    caption = "The test performance of the $32 \\times 32$ model presented with different model violations.",
                    escape = FALSE,
                    linesep = "", 
                    align = "lrr",
