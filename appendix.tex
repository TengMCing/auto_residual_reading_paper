...
\subsection{Neural Network Layers Used in the
...
\subsubsection{Dense Layer}\label{dense-layer}
...
\subsubsection{Global Pooling Layer}\label{global-pooling-layer}
...
Layer}\label{batch-normalization-layer}
...
\subsubsection{Dropout Layer}\label{dropout-layer}
