...
simulation model, where small \(\varepsilon\) variances caused
...
easiest to predict, with RMSE around \(0.3\). Non-linearity was harder
to assess than heteroskedasticity or non-normality. Plots with multiple
