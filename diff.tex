...
%DIF ADD paper.tex               Fri Feb 13 14:29:01 2026
% v1.04 - May 2023
...
\caption{\DIFaddFL{An example lineup embedding the true residual plot among 19 null plots, with the null plots generated via residual rotation to ensure consistency with $H_0$. Observers who have not previously seen the lineup are asked to identify the plot that appears most different. Under $H_0$ that the regression model is correctly specified, the true residual plot should be indistinguishable from the null plots, yielding a selection probability of 0.05. A small $p$-value arises when a substantial proportion of observers select the true residual plot (shown at position 10, exhibiting non-linearity).}}\label{fig:ex-lineup}
\end{figure}
...
\ref{sec-distance-of-p-from-q}. Although more sophisticated approaches,
such as working directly in the lower-rank subspace via
eigen-decomposition, are possible, we adopt a full-rank approximation
for simplicity and computational efficiency when constructing the
training dataset for the computer vision model.
}\DIFaddend 
...
To enable supervised training of \DIFaddbegin \DIFadd{the }\DIFaddend computer vision models for
detecting violations in linear regression, we \DIFaddbegin \DIFadd{require paired residual
plots and their corresponding \(D\) values to train a regression model.
We therefore }\DIFaddend generated a synthetic dataset \DIFaddbegin \DIFadd{consisting }\DIFaddend of 80,000 training
and 8,000 test residual plots. This simulation-based approach \DIFdelbegin \DIFdel{provided }\DIFdelend \DIFaddbegin \DIFadd{provides
}\DIFaddend full control over the data-generating process, \DIFdelbegin \DIFdel{allowing }\DIFdelend \DIFaddbegin \DIFadd{enabling }\DIFaddend precise
computation of \(D\), cost-effective \DIFdelbegin \DIFdel{data scaling }\DIFdelend \DIFaddbegin \DIFadd{scaling of the dataset}\DIFaddend , and the
ability to model \DIFdelbegin \DIFdel{diverse visual patterns of }\DIFdelend \DIFaddbegin \DIFadd{a wide range of visual patterns associated with }\DIFaddend model
violations.
...
summarises the number of training and test samples under the different
violation scenarios.
}\DIFaddend 
...
\begin{tabular}[t]{lrr}
\toprule
\DIFaddFL{Violations }& \DIFaddFL{\#train samples }& \DIFaddFL{\#test samples}\\
\midrule
\DIFaddFL{no violations }& \DIFaddFL{1546 }& \DIFaddFL{155}\\
\DIFaddFL{non-linearity }& \DIFaddFL{22184 }& \DIFaddFL{2218}\\
\DIFaddFL{heteroskedasticity }& \DIFaddFL{10826 }& \DIFaddFL{1067}\\
\DIFaddFL{non-linearity + heteroskedasticity }& \DIFaddFL{10221 }& \DIFaddFL{985}\\
\DIFaddFL{non-normality }& \DIFaddFL{10797 }& \DIFaddFL{1111}\\
\DIFaddFL{non-linearity + non-normality }& \DIFaddFL{8835 }& \DIFaddFL{928}\\
\DIFaddFL{heteroskedasticity + non-normality }& \DIFaddFL{7870 }& \DIFaddFL{819}\\
\DIFaddFL{non-linearity + heteroskedasticity + non-normality }& \DIFaddFL{7721 }& \DIFaddFL{717}\\
\bottomrule
\end{tabular}
\end{table}
...
\ref{tab:performance-sub}). It was found that null plots had the poorest
...
\caption{\label{tab:performance-sub}The \DIFaddbeginFL \DIFaddFL{train and }\DIFaddendFL test performance of the $32 \times 32$ model presented with different model violations.}
\centering
\begin{tabular}[t]{lrr}
\toprule
Violations & \DIFdelbeginFL \DIFdelFL{\#samples }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Train RMSE }\DIFaddendFL & \DIFaddbeginFL \DIFaddFL{Test }\DIFaddendFL RMSE\\
\midrule
no violations & \DIFdelbeginFL \DIFdelFL{155 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1.149 }\DIFaddendFL & 1.267\\
non-linearity & \DIFdelbeginFL \DIFdelFL{2218 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.625 }\DIFaddendFL & 0.787\\
heteroskedasticity & \DIFdelbeginFL \DIFdelFL{1067 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.528 }\DIFaddendFL & 0.602\\
non-linearity + heteroskedasticity & \DIFdelbeginFL \DIFdelFL{985 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.593 }\DIFaddendFL & 0.751\\
non-normality & \DIFdelbeginFL \DIFdelFL{1111 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.279 }\DIFaddendFL & 0.320\\
non-linearity + non-normality & \DIFdelbeginFL \DIFdelFL{928 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.472 }\DIFaddendFL & 0.600\\
heteroskedasticity + non-normality & \DIFdelbeginFL \DIFdelFL{819 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.354 }\DIFaddendFL & 0.489\\
non-linearity + heteroskedasticity + non-normality & \DIFdelbeginFL \DIFdelFL{717 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.432 }\DIFaddendFL & 0.620\\
\bottomrule
\end{tabular}
\end{table}
