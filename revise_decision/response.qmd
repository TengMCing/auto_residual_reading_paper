...
The lineup protocol was described in third paragraph of the Introduction, but more information can be obtainined in the cited reference in the paragraph. Since lineup protocol is not the main focus of this paper, we have added a brief description in the Introduction and provided a reference to the original paper for readers who are interested in learning more about it. To aid readers who are new to the concept, we have also included an example lineup figure (Figure 2) in the revised manuscript to visually illustrate the protocol and make the description easier to understand.
...
These three references are already cited in the manuscript. We are not sure if there was a misunderstanding, but we have confirmed that these references are present in the manuscript as required.
